...
intron_expected_types <- c(ref_junID = "NUMERIC", 
                           ...
                           misspliced = "BOOL", 
                           gene_id = "INTEGER")
intron_expected_notnull <- c(ref_junID = 1, ref_coordinates = 1, ref_length = 1, ref_ss5score = 1, ref_ss3score = 1, ref_cons5score = 1, ref_cons3score = 1, ref_CDTS5score = 1, ref_CDTS3score = 1, u2_intron = 0, u12_intron = 0, clinvar = 1, MANE = 1, TSL = 1, lncRNA = 1, protein_coding = 1, misspliced = 1, gene_id = 1)
intron_expected_pk <- c(ref_junID = 1, ref_coordinates = 0, ref_length = 0, ref_ss5score = 0, ref_ss3score = 0, ref_cons5score = 0, ref_cons3score = 0, ref_CDTS5score = 0, ref_CDTS3score = 0, u2_intron = 0, u12_intron = 0, clinvar = 0, MANE = 0, TSL = 0, lncRNA = 0, protein_coding = 0, misspliced = 0, gene_id = 0)
intron_expected_foreign <- c(table = "gene", from = "gene_id", to = "id")
...
novel_expected_types <- c(novel_junID = "NUMERIC", 
                          ...
                          novel_type = "TEXT",
                          distance = "INTEGER")
novel_expected_notnull <- c(novel_junID = 1, ref_junID = 1, novel_coordinates = 1, novel_ss5score = 1, novel_ss3score = 1, novel_type = 1, distance = 1)
novel_expected_pk <- c(novel_junID = 2, ref_junID = 1, novel_coordinates = 0, novel_ss5score = 0, novel_ss3score = 0, novel_type = 0, distance = 0)
...
master_expected_types <- c(age = "TEXT", 
                           ...
                           SRA_project_tidy = "TEXT", 
                           SRA_project = "TEXT")
master_expected_notnull <- c(age = 0, rin = 0, gender = 0, tissue = 0, cluster = 0, cluster_tidy = 0, smnabtcht = 0, sample_id = 0, smafrze = 0, avg_read_length = 0, mapped_read_count = 0, SRA_project_tidy = 0, SRA_project = 0)
master_expected_pk <- c(age = 0, rin = 0, gender = 0, tissue = 0, cluster = 0, cluster_tidy = 0, smnabtcht = 0, sample_id = 0, smafrze = 0, avg_read_length = 0, mapped_read_count = 0, SRA_project_tidy = 0, SRA_project = 0)
...
misspliced_expected_types <- c(ref_junID = "INTEGER", 
                               ...
                               gene_tpm = "DOUBLE",
                               gene_id = "INTEGER")
misspliced_expected_notnull <- c(ref_junID = 1, novel_junID = 1, ref_n_individuals = 1, ref_sum_counts = 1, ref_type = 1, novel_n_individuals = 1, novel_sum_counts = 1, MSR_D = 1, MSR_A = 1, gene_tpm = 0, gene_id = 1)
misspliced_expected_pk <- c(ref_junID = 0, novel_junID = 0, ref_n_individuals = 0, ref_sum_counts = 0, ref_type = 0, novel_n_individuals = 0, novel_sum_counts = 0, MSR_D = 0, MSR_A = 0, gene_tpm = 0, gene_id = 0)
misspliced_expected_foreign_gene_id <- c(table = "gene", from = "gene_id", to = "id")
...
never_expected_types <- c(ref_junID = "INTEGER", 
                          ...
                          gene_tpm = "DOUBLE",
                          gene_id = "INTEGER")
never_expected_notnull <- c(ref_junID = 1, ref_n_individuals = 1, ref_sum_counts = 1, MSR_D = 1, MSR_A = 1, ref_type = 1, gene_tpm = 0, gene_id = 1)
never_expected_pk <- c(ref_junID = 0, ref_n_individuals = 0, ref_sum_counts = 0, MSR_D = 0, MSR_A = 0, ref_type = 0, gene_tpm = 0, gene_id = 0)
never_expected_foreign_gene_id <- c(table = "gene", from = "gene_id", to = "id")
